...
-- 11
SELECT odate, WEEKDAY(odate)
FROM orders;



-- 12
SELECT odate, DAY(odate)
FROM orders;
-- DAYOFMONTH()
...
-- 32
SELECT NOW(), ADDDATE(NOW(), INTERVAL
1 SECOND);
...
-- 34
SELECT NOW(), ADDDATE(NOW(), INTERVAL '2:5'
DAY_HOUR);
...
-- 37
SELECT NOW(), SUBDATE(NOW(), INTERVAL
2 HOUR);
